...
//import Filter for the Sports page from PlaysFilter components since both are similar
                ...
                <div className="container mx-auto px-4">
                    <div className="w-full lg:flex lg:flex-row-reverse gap-5">
                        ...
                        <div className="lg:w-9/12">
                            <h2 className="text-2xl font-bold mb-4 px-3">Sports in Chandigarh</h2>
                            <div className="flex flex-wrap">
                                <div className="w-1/2 my-3 md:w-1/3 lg:w-3/12">
                                    <Poster src="https://in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:ote-TW9uLCAxOSBKdWwgb253YXJkcw%3D%3D,ots-29,otc-FFFFFF,oy-612,ox-24:oi-discovery-catalog@@icons@@bundle-icon-shadow-4x.png,ox-15,oy-15,ow-50/et00311675-wfqgcdyuue-portrait.jpg"
                                    title="Travelling Clues - Online Games"
                                    subtitle="English -> ₹149 onwards" /> 
                                </div>
                        ...
                        <div className="lg:w-3/12">
                            ...
                            <div>
                                ...
                                <PlaysFilter 
                                title="More Filters"
                                tags={["Online Streaming", "Kids Allowed", "Kids Activities"]} />
